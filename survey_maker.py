...
class SurveyMaker():
    ...
    def make_survey(self): 
        ...
        if params['params_mock_cat.maker_params.surveys.make_survey2'] == True:
            size_cat = params['params_mock_cat.maker_params.surveys.los1'] + params['params_mock_cat.maker_params.surveys.los2']
        else:
            size_cat = params['params_mock_cat.maker_params.surveys.los1'] 
        ...
        phi=np.random.uniform(params['params_mock_cat.maker_params.surveys.phi_low1']*np.pi,params['params_mock_cat.maker_params.surveys.phi_high1']*np.pi,params['params_mock_cat.maker_params.surveys.los1'])
        ra_deg1=phi*180.0/np.pi

        p_low= (np.sin(np.radians(params['params_mock_cat.maker_params.surveys.delta_low1']))+1.0)/2.0
        p_high= (np.sin(np.radians(params['params_mock_cat.maker_params.surveys.delta_high1']))+1.0)/2.0
        p=np.random.uniform(p_low,p_high,params['params_mock_cat.maker_params.surveys.los1'])
        ...
        catalog[0:params['params_mock_cat.maker_params.surveys.los1']]=params['params_mock_cat.maker_params.surveys.name1']
        ...
        if params['params_mock_cat.maker_params.surveys.make_survey2'] == True:
            ...
            catalog[params['params_mock_cat.maker_params.surveys.los1']:]=params['params_mock_cat.maker_params.surveys.name2']
