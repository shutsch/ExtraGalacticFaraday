...
def get_data(data):
    ...
    return {'rm': rm, 'rm_err': rm_err, 'z indices': z_indices, 'e_rm': e_rm, 'e_rm_err': e_rm_err, 'e_z': e_z, 'e_F': e_F, 'lerm': lerm,
            'g_rm': g_rm, 'g_rm_err': g_rm_err, 'g_F': g_F, 'lgrm': lgrm, 'eg_l': eg_l, 'eg_b': eg_b, 'theta_eg': theta_eg, 'phi_eg': phi_eg, 
            'ltheta': ltheta, 'lthetaeg': lthetaeg}    
