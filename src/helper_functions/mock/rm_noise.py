...
def rm_noise(params, data, dest_data, rm_err, ltheta, lerm, z_indices, figname):
        ...
        if params['params_mock_cat.maker_params.surveys.make_survey1'] == True:
            ...
            sigma_gal_mock=Egf.sampling_from_noise_distribiution(sigma_gal, ltheta-lerm)['sigma']
            ...
            sigma_eg_mock=Egf.sampling_from_noise_distribiution(sigma_eg,lerm)['sigma']
