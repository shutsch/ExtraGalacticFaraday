    ...
    def minimize(self):
        ...
        def plot_cb(latest_sample_list, i):
            ...
            if self.params['params_mock_cat.maker_params.npi.use_npi']==True:
                eta_plotting('noise_excitations',[s for s in latest_sample_list.iterator()], minimizer_params['plot_path'], minimizer_params['sigma_rm'], minimizer_params['gal_pos'], minimizer_params['mock_npi_indices'], minimizer_params['deviation'], string=ident)
