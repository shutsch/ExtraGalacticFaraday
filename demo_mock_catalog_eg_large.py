...
def run_inference():
    ...
    #Plot 1
    plot = ift.Plot()
    plot.add(o_projector.adjoint(o_rm_gal_data), vmin=-250, vmax=250)
    plot.add(o_projector.adjoint(noised_rm_data), vmin=-250, vmax=250)
    plot.add(rm_gal, vmin=-250, vmax=250)
    plot.output()
    ...
    hdu.writeto('/home/valentina/Documents/PROJECTS/BAYESIAN_CODE/DEFROST_LAST/ExtraGalacticFaraday/data/Faraday/catalog_versions/master_catalog_vercustom_eg_large.fits', overwrite=True)
    hdu.close()
