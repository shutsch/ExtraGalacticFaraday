...
class Posterior_Plotter():
    ...
    def plot(self, figname):
        ...
        axs[1,0].tick_params(labelbottom=True, direction='in', labelsize= self.params['plot.fontsize'])
        axs[0,1].tick_params(labelbottom=True, labelleft=False, direction='in', labelsize= self.params['plot.fontsize'])
        axs[0,2].tick_params(labelbottom=True, labelleft=False, direction='in', labelsize= self.params['plot.fontsize'])
        #axs[0,2].tick_params(labelleft=False, direction='in', labelsize= self.params['plot.fontsize'])
        axs[1,1].tick_params(labelbottom=False, labeltop=False, labelleft=False, labelright=False, direction='in', labelsize= self.params['plot.fontsize'])
        axs[0,0].tick_params(labelbottom=True, labelleft=True, direction='in', labelsize= self.params['plot.fontsize'])
        axs[2,0].tick_params(labelbottom=True, labelleft=True, direction='in', labelsize= self.params['plot.fontsize'])
        axs[2,1].tick_params(labelbottom=True, labelleft=False, direction='in', labelsize= self.params['plot.fontsize'])
        axs[3,0].tick_params(labelbottom=True, labelleft=False, direction='in',labelsize= self.params['plot.fontsize'])
        axs[1,2].tick_params(labelbottom=True, labelleft=False, direction='in',labelsize= self.params['plot.fontsize'])
        axs[0,3].tick_params(labelbottom=True, labelleft=False, direction='in', labelsize= self.params['plot.fontsize'])
        ...
        #axs[3,0].tick_params(axis='x', labelright=False, labelsize= self.params['plot.fontsize'])
