...
class RMTable:
    ...
    def verify_columns(self):
        if self.columns != self.table.colnames:
            print("Columns inconsistent with standard. "
                  "Check if deliberate (i.e., verify these aren't misspellings). Extraneous columns:")
    ...
    def append_to_table(self,table2, join_type='inner'):
